      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border-2 border-orange-500 rounded-xl p-8 hover:shadow-lg transition-shadow duration-300 bg-white">
              <h3 className="text-xl font-bold text-orange-600 mb-6">Find New Suppliers</h3>
            ...
            <div className="border-2 border-blue-500 rounded-xl p-8 hover:shadow-lg transition-shadow duration-300 bg-white">
              ...
              <div className="flex flex-col gap-3">
                <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg">
                  I need this plan
                </button>
                <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg">
                  I need this plan
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mb-4">
              To follow up on your response, submit your inquiries using the form. If you encounter any issues with submission, you can also email us directly at info@Taisourcing@gmail.com.
            </p>
            <p className="text-gray-600">
              To get the fastest response, submit your inquiries using the form. If you encounter any issues with submission, you can also email us directly at info@Taisourcing@gmail.com.
            </p>
