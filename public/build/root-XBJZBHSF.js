...
import {
  CartContents
} from "/build/_shared/chunk-OLT4PQNE.js";
import {
  Price
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1783499574623.6826";
}
var navItems = [{
  label: "Our Services",
  children: [{
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", { className: classNames(isScrollingUp ? "sticky top-0 z-50 animate-dropIn" : "", "bg-white shadow-md"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "max-w-7xl mx-auto px-6 py-3 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center space-x-4", children: [
      ...
      isProductPage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "hidden md:block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: isSignedIn ? "/account" : "/sign-in", className: "flex items-center space-x-1 text-gray-700 hover:text-orange-500 transition-colors duration-300", children: [
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1783496911911.832";
}
function Footer({
  collections
}) {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ul", { className: "space-y-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("li", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("a", { href: "mailto:info@taisourcing.asia", className: "text-gray-400 hover:text-orange-500 text-sm transition-colors", children: "info@taisourcing.asia" }, void 0, false, {
              fileName: "app/components/footer/Footer.tsx",
              lineNumber: 85,
              columnNumber: 17
            }, this)
...
//# sourceMappingURL=/build/root-XBJZBHSF.js.map
