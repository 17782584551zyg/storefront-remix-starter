...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\tabs\\\\Tab.tsx"' + id);
  };
...
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\components\\tabs\\Tab.tsx"
  );
  import.meta.hot.lastModified = "1782487989391.3909";
}
function Tab({
  Icon,
  text,
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\tabs\\\\TabsContainer.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\components\\tabs\\TabsContainer.tsx"
  );
  import.meta.hot.lastModified = "1782487989396.7175";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1782487989524.8462";
}
...
//# sourceMappingURL=/build/routes/account-SKL3LXPO.js.map
