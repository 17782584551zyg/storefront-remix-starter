...
export function getImageUrl(preview: string | undefined, options: { w?: number; h?: number; preset?: string } = {}): string {
  if (!preview) {
    return 'data:image/svg+xml,%3Csvg xmlns=\
http://www.w3.org/2000/svg\ viewBox=\0
0
200
200\%3E%3Crect fill=\%23f3f4f6\ width=\200\ height=\200\/%3E%3Ctext fill=\%239ca3af\ font-family=\sans-serif\ font-size=\14\ x=\50%25\ y=\50%25\ text-anchor=\middle\ dy=\.3em\%3ENo image%3C/text%3E%3C/svg%3E';
  }
