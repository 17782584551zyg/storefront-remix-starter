...
`)))!==null&&t!==void 0?t:!1}var X=new Map,pe=new Map,Pe=!0,Z=!1;function Fe(e){return e.replace(/[\s,]+/g," ").trim()}function ot(e){return Fe(e.source.body.substring(e.start,e.end))}function lt(e){var t=new Set,r=[];return e.definitions.forEach(function(n){if(n.kind==="FragmentDefinition"){var a=n.name.value,i=ot(n.loc),o=pe.get(a);o&&!o.has(i)?Pe&&console.warn("Warning: fragment with name "+a+` already exists.
graphql-tag enforces all fragment names across your application to be unique; read more about
this in the docs: http://dev.apollodata.com/core/fragments.html#unique-names`):o||pe.set(a,o=new Set),o.add(i),t.has(i)||(t.add(i),r.push(n))}else r.push(n)}),w(w({},e),{definitions:r})}function pt(e){var t=new Set(e.definitions);t.forEach(function(n){n.loc&&delete n.loc,Object.keys(n).forEach(function(a){var i=n[a];i&&typeof i=="object"&&t.add(i)})});var r=e.loc;return r&&(delete r.startToken,delete r.endToken),e}function ut(e){var t=Fe(e);if(!X.has(t)){var r=Y(e,{experimentalFragmentVariables:Z,allowLegacyFragmentVariables:Z});if(!r||r.kind!=="Document")throw new Error("Not a valid GraphQL document.");X.set(t,pt(lt(r)))}return X.get(t)}function k(e){for(var t=[],r=1;r<arguments.length;r++)t[r-1]=arguments[r];typeof e=="string"&&(e=[e]);var n=e[0];return t.forEach(function(a,i){a&&a.kind==="Document"?n+=a.loc.source.body:n+=a,n+=e[i+1]}),ut(n)}function ct(){X.clear(),pe.clear()}function dt(){Pe=!1}function mt(){Z=!0}function yt(){Z=!1}var G={gql:k,resetCaches:ct,disableFragmentWarnings:dt,enableExperimentalFragmentVariables:mt,disableExperimentalFragmentVariables:yt};(function(e){e.gql=G.gql,e.resetCaches=G.resetCaches,e.disableFragmentWarnings=G.disableFragmentWarnings,e.enableExperimentalFragmentVariables=G.enableExperimentalFragmentVariables,e.disableExperimentalFragmentVariables=G.disableExperimentalFragmentVariables})(k||(k={}));k.default=k;var u=k;var x=u`
