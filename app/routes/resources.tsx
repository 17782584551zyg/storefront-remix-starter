  ...
  const chapters = [
    {
      ...
      subtitle: t('resources.chapter1Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter2Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter3Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter4Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter5Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter6Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter7Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter8Subtitle'),
    ...
    },
    {
      ...
      subtitle: t('resources.chapter9Subtitle'),
      duration: '15 mins video, 7 mins read',
      image:
    ...
    },
    {
      ...
      subtitle: t('resources.chapter10Subtitle'),
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 via-orange-400 to-amber-500 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">
            {t('resources.exclusiveTips')}
          </h1>
          <p className="text-white/90 text-lg mb-8 leading-relaxed">
            {t('resources.exclusiveTipsDesc')}
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-6">{t('resources.askForAgent')}</p>
              <form className="space-y-4">
                <input
                  type="text"
                  placeholder={t('resources.firstName')}
