...
} from "/build/_shared/chunk-OVYZ4AGI.js";
import {
  classNames
...
import "/build/_shared/chunk-5JFNL5Q2.js";
import "/build/_shared/chunk-DRHEKX2C.js";
import {
  $,
  A,
  C,
...
import "/build/_shared/chunk-XTHRZFNV.js";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1783321793261.3655";
}
function AddressForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "fullName", className: "block text-sm font-medium text-gray-700", children: [
        t2("account.fullName"),
        " ",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", id: "fullName", name: "fullName", defaultValue: defaultFullName, autoComplete: "given-name", required: true, onBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
        fileName: "app/components/account/AddressForm.tsx",
        lineNumber: 39,
        columnNumber: 11
      }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "sm:col-span-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "streetLine1", className: "block text-sm font-medium text-gray-700", children: [
        t2("address.streetLine1"),
        " ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-red-500", children: "*" }, void 0, false, {
          fileName: "app/components/account/AddressForm.tsx",
          lineNumber: 54,
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", name: "streetLine1", id: "streetLine1", defaultValue: address?.streetLine1 ?? "", autoComplete: "street-address", required: true, onBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
        fileName: "app/components/account/AddressForm.tsx",
        lineNumber: 57,
        columnNumber: 11
      }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "city", className: "block text-sm font-medium text-gray-700", children: [
        t2("address.city"),
        " ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-red-500", children: "*" }, void 0, false, {
          fileName: "app/components/account/AddressForm.tsx",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", name: "city", id: "city", autoComplete: "address-level2", defaultValue: address?.city ?? "", required: true, onBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
        fileName: "app/components/account/AddressForm.tsx",
        lineNumber: 75,
        columnNumber: 11
      }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "countryCode", className: "block text-sm font-medium text-gray-700", children: [
        t2("address.country"),
        " ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-red-500", children: "*" }, void 0, false, {
          fileName: "app/components/account/AddressForm.tsx",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-1", children: availableCountries && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("select", { id: "countryCode", name: "countryCode", defaultValue: address?.countryCode ?? "US", required: true, onBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("option", { value: "", disabled: true, children: t2("address.selectCountry") }, void 0, false, {
          fileName: "app/components/account/AddressForm.tsx",
          lineNumber: 85,
          columnNumber: 15
        }, this),
        availableCountries.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("option", { value: item.code, children: item.name }, item.id, false, {
          fileName: "app/components/account/AddressForm.tsx",
          lineNumber: 88,
          columnNumber: 47
        }, this))
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "postalCode", className: "block text-sm font-medium text-gray-700", children: [
        t2("address.postalCode"),
        " ",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-red-500", children: "*" }, void 0, false, {
          fileName: "app/components/account/AddressForm.tsx",
          lineNumber: 106,
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", name: "postalCode", id: "postalCode", defaultValue: address?.postalCode ?? "", autoComplete: "postal-code", required: true, onBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
        fileName: "app/components/account/AddressForm.tsx",
        lineNumber: 109,
        columnNumber: 11
      }, this) }, void 0, false, {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1782487989281.5605";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1782487989275.5784";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1783321794221.7922";
}
function CheckoutShipping() {
  ...
  const customerFormRef = (0, import_react8.useRef)(null);
  const addressFormRef = (0, import_react8.useRef)(null);
  ...
  const canProceedToPayment = hasCustomerInfo && (hasShippingAddress || hasSelectedAddress) && hasShippingMethod && activeOrder?.lines?.length > 0;
  ...
  const navigateToPayment = async () => {
    if (isSubmitting || !canProceedToPayment)
      return;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
      ...
      isSignedIn ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
        ...
        lineNumber: 218,
        columnNumber: 23
      }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form, { ref: customerFormRef, method: "post", action: "/api/active-order", onSubmit: handleCustomerFormSubmit, onChange: () => setCustomerFormChanged(true), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-4", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("input", { type: "email", id: "emailAddress", name: "emailAddress", autoComplete: "email", defaultValue: customer?.emailAddress, required: true, onBlur: handleCustomerBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
            fileName: "app/routes/checkout._index.tsx",
            lineNumber: 230,
            columnNumber: 17
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("input", { type: "text", id: "firstName", name: "firstName", autoComplete: "given-name", defaultValue: customer?.firstName, required: true, onBlur: handleCustomerBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
              fileName: "app/routes/checkout._index.tsx",
              lineNumber: 242,
              columnNumber: 19
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("input", { type: "text", id: "lastName", name: "lastName", autoComplete: "family-name", defaultValue: customer?.lastName, required: true, onBlur: handleCustomerBlur, className: "block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" }, void 0, false, {
              fileName: "app/routes/checkout._index.tsx",
              lineNumber: 251,
              columnNumber: 19
            }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form, { ref: addressFormRef, method: "post", action: "/api/active-order", onSubmit: handleAddressFormSubmit, onChange: () => setAddressFormChanged(true), children: [
      ...
      isSignedIn && activeCustomer.addresses?.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(ShippingAddressSelector, { addresses: activeCustomer.addresses, selectedAddressIndex, onChange: submitSelectedAddress }, void 0, false, {
          fileName: "app/routes/checkout._index.tsx",
          lineNumber: 266,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "mt-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { type: "button", onClick: () => setSelectedAddressIndex(-1), className: "text-sm text-primary-600 hover:text-primary-800", children: t2("checkout.addNewAddress") }, void 0, false, {
          fileName: "app/routes/checkout._index.tsx",
          lineNumber: 268,
          columnNumber: 15
        }, this) }, void 0, false, {
        ...
        lineNumber: 265,
        columnNumber: 59
      }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(AddressForm, { availableCountries, address: shippingAddress, defaultFullName, onBlur: handleAddressBlur }, void 0, false, {
        fileName: "app/routes/checkout._index.tsx",
        lineNumber: 272,
        columnNumber: 20
      }, this),
      isSignedIn && !activeCustomer.addresses?.length && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(AddressForm, { availableCountries, address: shippingAddress, defaultFullName, onBlur: handleAddressBlur }, void 0, false, {
        fileName: "app/routes/checkout._index.tsx",
        lineNumber: 273,
        columnNumber: 61
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { type: "button", disabled: !canProceedToPayment || isSubmitting, onClick: navigateToPayment, className: classNames(canProceedToPayment && !isSubmitting ? "bg-primary-600 hover:bg-primary-700" : "bg-gray-400", "flex w-full items-center justify-center space-x-2 mt-24 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"), children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_solid3.LockClosedIcon, { className: "w-5 h-5" }, void 0, false, {
        fileName: "app/routes/checkout._index.tsx",
        lineNumber: 281,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { children: isSubmitting ? t2("checkout.processing") : t2("checkout.goToPayment") }, void 0, false, {
        fileName: "app/routes/checkout._index.tsx",
        lineNumber: 282,
        columnNumber: 9
      }, this)
...
_s3(CheckoutShipping, "Yhw/a0DU7k5uPMEKwyKfQCNigtY=", false, function() {
...
//# sourceMappingURL=/build/routes/checkout._index-4RGR7YIY.js.map
