...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1782559336657.9329";
}
...
function getSdk(requester) {
  return {
    ...
    updateCustomerAddress(variables, options) {
      return requester(UpdateCustomerAddressDocument, variables, options);
    },
    ...
    updateCustomerPassword(variables, options) {
      return requester(UpdateCustomerPasswordDocument, variables, options);
    },
    activeChannel(variables, options) {
      return requester(ActiveChannelDocument, variables, options);
    },
    ...
    nextOrderStates(variables, options) {
      return requester(NextOrderStatesDocument, variables, options);
    },
    ...
    createStripePaymentIntent(variables, options) {
      return requester(CreateStripePaymentIntentDocument, variables, options);
    },
    generateBraintreeClientToken(variables, options) {
      return requester(GenerateBraintreeClientTokenDocument, variables, options);
    },
    ...
    activeCustomer(variables, options) {
      return requester(ActiveCustomerDocument, variables, options);
    },
    activeCustomerDetails(variables, options) {
      return requester(ActiveCustomerDetailsDocument, variables, options);
    },
    ...
    activeCustomerOrderList(variables, options) {
      return requester(ActiveCustomerOrderListDocument, variables, options);
    },
    ...
    searchFacetValues(variables, options) {
      return requester(SearchFacetValuesDocument, variables, options);
    }
  };
}
...
//# sourceMappingURL=/build/_shared/chunk-FX3BUYEM.js.map
